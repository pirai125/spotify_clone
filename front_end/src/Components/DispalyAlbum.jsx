...
export default function DispalyAlbum({ album }) {
  const { id } = useParams();
  ...
  useEffect(() => {
    albumsData.map((item) => {
      if (item._id == id) setAlbumData(item);
    });
  }, []);
      ...
      <div className="mt-10 flex flex-col gap-8 md:flex-row md:items-end">
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-1">
            ...
            />
            <b>Spotify </b>- 1,23,456 likes - <b>50 songs</b> about 2 hr 30 min
          </p>
        </div>
      </div>
      ...
      {songsData
        ...
        .map((item, index) => (
          ...
          >
            ...
            <p className="text-[15px] hidden sm:block">5 days before</p>
